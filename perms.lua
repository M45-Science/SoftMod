...
function set_blueprints_enabled(group, enabled)
  if group ~= nil then
    global.defaultgroup.set_allows_action(defines.input_action.wire_dragging, true)
    global.defaultgroup.set_allows_action(defines.input_action.activate_cut, true)
    global.defaultgroup.set_allows_action(defines.input_action.add_train_station, true)
    global.defaultgroup.set_allows_action(defines.input_action.build_terrain, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_arithmetic_combinator_parameters, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_decider_combinator_parameters, true)
    global.defaultgroup.set_allows_action(defines.input_action.switch_constant_combinator_state, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_programmable_speaker_alert_parameters, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_programmable_speaker_circuit_parameters, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_programmable_speaker_parameters, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_train_stop_station, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_train_wait_condition, true)
    global.defaultgroup.set_allows_action(defines.input_action.change_train_wait_condition_data, true)
    global.defaultgroup.set_allows_action(defines.input_action.connect_rolling_stock, true)
    global.defaultgroup.set_allows_action(defines.input_action.deconstruct, true)
    global.defaultgroup.set_allows_action(defines.input_action.disconnect_rolling_stock, true)
    global.defaultgroup.set_allows_action(defines.input_action.drag_train_schedule, true)
    global.defaultgroup.set_allows_action(defines.input_action.drag_train_wait_condition, true)
    global.defaultgroup.set_allows_action(defines.input_action.launch_rocket, true)
    global.defaultgroup.set_allows_action(defines.input_action.remove_cables, true)
    global.defaultgroup.set_allows_action(defines.input_action.remove_train_station, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_auto_launch_rocket, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_circuit_condition, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_circuit_mode_of_operation, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_logistic_filter_item, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_logistic_filter_signal, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_request_from_buffers, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_signal, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_train_stopped, true)
    --Added 12-2020
    global.defaultgroup.set_allows_action(defines.input_action.cancel_research, true)
    global.defaultgroup.set_allows_action(defines.input_action.upgrade, true)
    global.defaultgroup.set_allows_action(defines.input_action.cancel_upgrade, true)
    ...
    global.defaultgroup.set_allows_action(defines.input_action.flush_opened_entity_fluid, true)
    global.defaultgroup.set_allows_action(defines.input_action.flush_opened_entity_specific_fluid, true)
    global.defaultgroup.set_allows_action(defines.input_action.paste_entity_settings, true)
    global.defaultgroup.set_allows_action(defines.input_action.set_auto_launch_rocket, true)
    global.defaultgroup.set_allows_action(defines.input_action.use_artillery_remote, true)
    global.defaultgroup.set_allows_action(defines.input_action.upgrade, true)

    --Added 2-2020
    global.defaultgroup.set_allows_action(defines.input_action.drop_item, true)

    --Added 1-2022
    global.defaultgroup.set_allows_action(defines.input_action.delete_blueprint_library, true)
    global.defaultgroup.set_allows_action(defines.input_action.drop_blueprint_record, true)
    global.defaultgroup.set_allows_action(defines.input_action.import_blueprint, true)
    global.defaultgroup.set_allows_action(defines.input_action.import_blueprint_string, true)
    global.defaultgroup.set_allows_action(defines.input_action.import_blueprints_filtered, true)
    global.defaultgroup.set_allows_action(defines.input_action.reassign_blueprint, true)
  end
end
